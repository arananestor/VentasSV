...
# Testing
npm test               # Run all tests (743 tests, 51 suites — must be 0 failures)
...
- **Rule: 743 tests (minimum), 0 failures before any merge. No exceptions.**
