...
# Testing
npm test               # Run all tests (629 tests, 41 suites — must be 0 failures)
...
- **Rule: 629 tests (minimum), 0 failures before any merge. No exceptions.**
...
17. Modos de operación Fase 1 (foundation) — in progress
18. Modos de operación Fase 2 (cajero UI) — pending
19. Modos de operación Fase 3 (gestión owner) — pending
