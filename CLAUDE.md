...
# Testing
npm test               # Run all tests (652 tests, 44 suites — must be 0 failures)
...
- **Rule: 652 tests (minimum), 0 failures before any merge. No exceptions.**
