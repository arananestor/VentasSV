...
export default function PaymentScreen({ route, navigation }) {
  ...
  const takePhoto = async () => {
    ...
    if (status !== 'granted') {
      Alert.alert('', 'Necesitamos acceso a la cámara');
      return;
    }
    ...
    <SafeAreaView style={styles.container}>
            ...
            <View style={styles.quickGrid}>
              {quickAmounts.map(amount => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.quickBtn,
                    parseFloat(cashGiven) === amount && styles.quickBtnActive,
                  ]}
                  onPress={() => setCashGiven(amount.toString())}
                >
                  <Text style={[
                    styles.quickBtnText,
                    parseFloat(cashGiven) === amount && styles.quickBtnTextActive,
                  ]}>
                    ${amount}
                  </Text>
                </TouchableOpacity>
              ...
              <TouchableOpacity
                style={[
                  styles.quickBtn,
                  parseFloat(cashGiven) === order.total && styles.quickBtnActive,
                ]}
              ...
              >
                <Text style={[
                  styles.quickBtnText,
                  { fontSize: 11 },
                  parseFloat(cashGiven) === order.total && styles.quickBtnTextActive,
                ]}>
                  EXACTO
                </Text>
              </TouchableOpacity>
      ...
      {paymentMethod && (
        <View style={styles.bottomBar}>
          ...
          >
            <Text style={[styles.doneText, !canComplete && styles.doneTextDisabled]}>
              ✓  LISTO
            </Text>
          </TouchableOpacity>
        </View>
