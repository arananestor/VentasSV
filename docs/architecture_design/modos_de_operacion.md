...
Las pestañas (tabs) siguen siendo una entidad independiente con su propio CRUD actual, pero su array de productos deja de ser consultado para decidir disponibilidad en HomeScreen; solo se usa para agrupación visual cuando el Modo activo las lista en su tabOrder.
...
PR 2 queda verificado si: el cajero ve solo los productos activos del Modo activo, los precios con override se aplican al agregar al carrito, el orden de tabs respeta tabOrder, el indicador de Modo activo aparece en HomeScreen, y los tests cubren filtrado y priceOverride.
