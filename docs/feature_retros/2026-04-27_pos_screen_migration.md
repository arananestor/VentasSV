# Feature Retro: Rename POSScreen to POSScreen + useResponsive Migration
...
Renamed POSScreen.js → POSScreen.js. Migrated from static Dimensions.get('window') to useResponsive hook for dynamic grid calculations. Test files renamed accordingly.

## Cambios

- **src/screens/POSScreen.js → src/screens/POSScreen.js** — function renamed to POSScreen, Dimensions import removed, useResponsive provides CARD_SIZE/PADDING/CARD_GAP dynamically. Grid/card styles moved inline for dynamic sizing.
...
- **CLAUDE.md** — all POSScreen references → POSScreen, test suite names updated.
