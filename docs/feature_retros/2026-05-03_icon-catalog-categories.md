...
- **src/screens/AddProductScreen.js** — Eliminados estados showColorPicker y showIconPicker, reemplazados por showIconColorPicker. Eliminados los dos pickerRow ("Color de fondo" y "Elegir ícono"). iconPreviewWrap convertido a TouchableOpacity que abre IconColorPicker. Eliminados Modal de COLOR FONDO PRODUCTO y BottomSheetModal de ICON PICKER producto. Icon picker de ingrediente usa IconColorPicker con hideColors. Estilos huérfanos eliminados (pickerRow, pickerRowText, colorDot, catHeader, iconGrid, iconGridBtn). Imports de FlatList, useWindowDimensions, BottomSheetModal, ICON_CATALOG, searchIcons, getIconBtnSize, getIconCols eliminados (ahora dentro de IconColorPicker).
- **src/screens/ModeEditorScreen.js** — Eliminados estados showEditColorPicker y showEditIconPicker, reemplazados por showEditIconColorPicker. Los dos botones separados (Color + Ícono) reemplazados por preview touchable. Modal de color picker y BottomSheetModal de product icon picker reemplazados por IconColorPicker. Icon picker de ingrediente usa IconColorPicker con hideColors. Imports de FlatList, useWindowDimensions, BottomSheetModal, ICON_CATALOG, getIconBtnSize, getIconCols eliminados.
...
- La prop hideColors permite reusar IconColorPicker para ingredientes (solo íconos con buscador) sin duplicar código
- Todos los icon pickers de la app ahora tienen buscador y categorías — experiencia consistente
